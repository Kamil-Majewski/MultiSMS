...
namespace MultiSMS.MVC.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<Administrator> signInManager, ILogger<LoginModel> logger, UserManager<Administrator> userManager)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (claims.Count > 0)
                    {
                        ...
                        {
                            if (claim.Type == "Password" && claim.Value == "ChangePasswordOnLogin")
                            {
                                return RedirectToPage("./ChangePasswordOnLogin");
                            }
                        }
                    }
                    else
